    ...
    <footer className="relative isolate overflow-hidden border-t border-border bg-bg">
      ...
      <div className="relative mx-auto max-w-7xl px-4 pb-6 pt-14 sm:px-6 sm:pb-8 sm:pt-20 lg:px-8">
        <div className="grid gap-10 sm:grid-cols-2 sm:gap-12 lg:grid-cols-4 lg:gap-14">
          <div className="sm:col-span-2 lg:col-span-1">
            <Link href="/" className="inline-flex items-center">
              <Image
                ...
                width={220}
                height={80}
                className="h-12 w-auto transition-transform duration-300 hover:scale-[1.02] sm:h-14"
                priority
              />
            </Link>
          ...
          <div className="order-2 sm:order-1 lg:order-none lg:col-span-1">
            ...
            <div className="mt-6 sm:mt-8">
              <Link
                href="/contact"
                className="group inline-flex items-center gap-3 rounded-full border border-white/10 bg-gradient-to-r from-primary/90 via-primary to-primary/75 px-6 py-3 text-sm font-semibold text-white shadow-[0_32px_70px_-48px_rgba(33,92,101,0.9)] transition-all duration-300 hover:scale-[1.02] sm:px-8 sm:text-base"
              >
          ...
          <div className="order-3 sm:order-2 lg:order-none lg:col-span-2">
            <div className="relative overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_40px_110px_-80px_rgba(12,18,26,1)] backdrop-blur-lg sm:p-8">
              ...
              <div className="pointer-events-none absolute inset-x-10 top-1/2 h-px -translate-y-1/2 bg-gradient-to-r from-transparent via-white/15 to-transparent" />
              <div className="relative z-10 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                <div className="max-w-xl">
                  <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-1 text-xs font-semibold uppercase tracking-[0.35em] text-primary/80">
                    Updates
                  </span>
                  <h3 className="mt-4 text-2xl font-semibold text-white sm:text-[2rem] sm:leading-tight">
                    Newsletter from the studio.
                  </h3>
                  <p className="mt-3 text-sm text-text-dim sm:text-base">
                    Essays, behind-the-scenes, and exhibition invitations—sent only
              ...
              <form onSubmit={onSubmit} className="relative z-10 mt-6 sm:mt-8">
                <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                  <div className="flex flex-1 items-center overflow-hidden rounded-full border border-white/60 bg-white px-3 py-2 shadow-[0_24px_65px_-40px_rgba(12,18,26,0.4)] transition-all focus-within:border-primary/60 focus-within:ring-2 focus-within:ring-primary/40 focus-within:ring-offset-2 focus-within:ring-offset-white focus-within:shadow-[0_28px_90px_-50px_rgba(51,161,170,0.55)]">
                    <Input
                      id="newsletter-email"
                      size="md"
                      type="email"
                      ...
                      className="h-12 flex-1 border-0 bg-transparent px-4 text-sm text-slate-600 placeholder:text-slate-400 focus-visible:outline-none focus-visible:ring-0 sm:text-base"
                    ...
                    <div className="pl-2">
                      <Button
                        type="submit"
                        size="md"
                        className="h-10 rounded-full bg-primary px-6 text-sm font-semibold text-white shadow-none transition hover:bg-primary/90 sm:h-11 sm:px-7 sm:text-base"
        ...
        <div className="mt-10 border-t border-white/10 pt-5 text-center text-xs text-text-dim sm:mt-12 sm:text-sm md:text-left">
          &copy; {new Date().getFullYear()} Michael Martin Photography. All rights reserved.
        </div>
      </div>
    </footer>
  );
